...
사용:
  .venv/Scripts/python.exe MPC/src/affine/09_walk.py               # 제자리 스텝 (Step 5)
  .venv/Scripts/python.exe MPC/src/affine/09_walk.py --vx 0.3      # 전진 (Step 6)
  .venv/Scripts/python.exe MPC/src/affine/09_walk.py --view --vx 0.3
"""
