...
사용:
  .venv/Scripts/python.exe MPC/src/baseline/08_standing_mpc.py           # 헤드리스 20초+push, 로그 저장
  .venv/Scripts/python.exe MPC/src/baseline/08_standing_mpc.py --view    # 뷰어 (Ctrl+우클릭 드래그로 밀어보기)
"""
