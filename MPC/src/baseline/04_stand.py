...
사용:
  .venv/Scripts/python.exe MPC/src/baseline/04_stand.py            # 30초 + 외란 테스트 (헤드리스)
  .venv/Scripts/python.exe MPC/src/baseline/04_stand.py --view     # 뷰어로 보기
  .venv/Scripts/python.exe MPC/src/baseline/04_stand.py --view --pd # 자세 PD 를 얹어서 보기
"""
