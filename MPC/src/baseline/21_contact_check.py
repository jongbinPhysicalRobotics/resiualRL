...
사용:
  .venv/Scripts/python.exe MPC/src/baseline/21_contact_check.py --vx 0.5 0.7
  .venv/Scripts/python.exe MPC/src/baseline/21_contact_check.py --vx 0.5 --var "soft_land=0"   (sin 아치와 비교)
"""
