...
사용 (09_walk 와 같은 플래그 + 아래):
  .venv/Scripts/python.exe MPC/src/23_walk_affine.py --check --vx 0.5 --seconds 20 [권장 플래그]
  .venv/Scripts/python.exe MPC/src/23_walk_affine.py --vx 0.5 --seconds 40 [권장 플래그]
  .venv/Scripts/python.exe MPC/src/23_walk_affine.py --view --vx 0.5 [권장 플래그]
